...
public class CubicSplineCurveMaker implements CurveMaker {
    private static final int STEPS = 100;
    public static final Matrix M_S = Matrix.makeEmptyMatrix(4).fill(new double[][]{new double[]{-1, 3, -3, 1}, new double[]{3, -6, 0, 4}, new double[]{-3, 3, 3, 1}, new double[]{1, 0, 0, 0}}).multiplyEach(1d / 6d);
